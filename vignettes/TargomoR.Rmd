...
| [Polygons](https://cwthom.github.io/TargomoR/articles/Polygons.html) | `addTargomoPolygons()`, `polygonDrawOptions()` |
| [Routes](https://cwthom.github.io/TargomoR/articles/Routes.html)     | `addTargomoRoutes()`, `routeDrawOptions()`     |
| [Times](https://cwthom.github.io/TargomoR/articles/Times.html)       | `addTargomoTimes()`, `timeDrawOptions()`       |
...
The following code snippet shows how easy it is to add detailed routing data to a `leaflet` map, in just a few function calls.
