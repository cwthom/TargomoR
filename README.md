...
Please see below for information on [installing](#installation) the
package, setting up your [environment](#set-up-environment) correctly,
and [using](#get-travel-time-data) the package.
...
region](https://targomo.com/developers/availability/). In the examples
on this page the region is “britishisles”.
...
There are three services currently supported:
  ...
  - [Isochrone
    Polygons](https://targomo.com/developers/services/polygon/)
